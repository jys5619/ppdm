...
export function QueryForm() {
  ...
  let mainIQueryForms: IQueryForm[] = [
      ...
      sqlList: [
        {
          title: 'DEPT조회',
          description:
            'EMP 데이터 조회 DEPT: ACCOUNTING, RESEARCH, SALES, OPERATIONS',
          sql: 'SELECT * FROM TB_DEPT WHERE DNAME = :dname',
        },
        {
          title: 'EMP조회',
          description:
            'EMP 데이터 조회 JOB: PRESIDENT, MANAGER, SALESMAN, CLERK, ANALYST',
    ...
    },
    {
      title: 'EMP 조회',
      favorites:
        '#ACCOUNTING,PRESIDENT #RESEARCH,PRESIDENT #SALES,MANAGER #OPERATIONS,ANALYST',
      description: `EMP 조회
